...
@Service
public class MonthLimitFactor extends BaseRiskFactor implements RuleCollector {
	@Autowired
	...
	private final int timeout = 60 * 60 * 24 * 31;
	
	@Override
	public Object execute(RuleContext context, Object... args) {
		float f = Float.valueOf(args[1].toString());
		String key = context.getInterfaceName() + ",ml," + externalArguments[0].getName() + "," + externalArguments[1].getName() + "," + args[0].toString() + "," + getMonth();
	...
	public String getCollectorKey() {
		return "ml," + externalArguments[0].getName() + "," + externalArguments[1].getName();
	}
	...
	public void collect(String interfaceName, Object[] args,
		...
		float f = Float.valueOf(args[1].toString());
		String key = interfaceName + ",ml," + externalArguments[0].getName() + "," + externalArguments[1].getName() + "," + args[0].toString() + "," + getMonth();
