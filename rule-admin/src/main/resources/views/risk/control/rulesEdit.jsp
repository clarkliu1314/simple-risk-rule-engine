...
<script type="text/javascript" src="js/rulesEdit.js"></script>
    ...
    <div data-options="region:'center',title:'规则编辑'" style="padding:5px;">
    	<div id="editRules" style="display: none;line-height: ">
						...
						<span>有效期:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="combo" style="width: 150px; height: 20px; line-height: 20px; "><input type="text"
							readonly="readonly" class="combo-text validatebox-text" onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss'})"
							id="startTime" style="width: 150px"></span><img
							onclick="WdatePicker({el:'startTime',skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss'})"
							...
							class="combo-text validatebox-text" onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss'})" id="endTime"
							style="width: 150px"></span><img
							onclick="WdatePicker({el:'endTime',skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss'})"
							src="js/skin/datePicker.gif" width="20px" height="40px"
							...
							onclick="WdatePicker({skin:'whyGreen',dateFmt:'HH:mm'})" style="width: 150px"></span><img
							onclick="WdatePicker({el:'startInterval',skin:'whyGreen',dateFmt:'HH:mm'})"
							src="js/skin/datePicker.gif" width="20px" height="40px"
							...
							onclick="WdatePicker({skin:'whyGreen',dateFmt:'HH:mm'})" style="width: 150px" /></span><img
							onclick="WdatePicker({el:'endInterval',skin:'whyGreen',dateFmt:'HH:mm'})"
							src="js/skin/datePicker.gif" width="20px" height="40px"
							align="absmiddle"> &nbsp;&nbsp;&nbsp;&nbsp;
							<div class="btn-group">
								<button class="btn" id="saveBtn" onclick="save()">保存</button>
								<button class="btn" id="deleteBtn" onclick="deleteRules()">删除</button>
								<button class="btn" id="showReason" onclick="$('#dlg').dialog('open')">拒绝原因</button>
							</div>
						</span>
					</div> 
    </div>  
