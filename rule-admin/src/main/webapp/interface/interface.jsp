...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/ccmis/style/themes/default/easyui.css">
	<link rel="stylesheet" type="text/css" href="/ccmis/style/themes/icon.css">
	<script type="text/javascript" src="/ccmis/style/js/jquery-1.8.0.min.js"></script>
	<script type="text/javascript" src="/ccmis/style/js/jquery.easyui.min.js"></script>
	<script type="text/javascript" src="/ccmis/style/locale/easyui-lang-zh_CN.js"></script>
	
	<script type="text/javascript" src="/ccmis/style/js/datagrid-detailview.js"></script> 
